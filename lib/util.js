...
Util.canvasBCR = function() {
  return document.getElementById("CarreCanvas").getBoundingClientRect();
};

Util.fade = function( elem, opacity ) {
  (typeof elem === "string") && ( elem = document.getElementById( elem ) );

  elem.style.opacity = opacity;
}

Util.toggleFade = function( elem, opacity ) {
  (typeof elem === "string") && ( elem = document.getElementById( elem ) );
  ...
  } else if ( elem.style.opacity == opacity ) {
