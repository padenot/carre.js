...
Carre.DisplayComponents.Bumper = {
  resources : "assets/sprites/bumper.png",
  sprite : null,
  spritewidth : 120,
  load: function() {
    var _this = this;
  ...
  display: function(gameObject, renderingContext, elapsedTime) {
    var camera_x = Carre.GameLogic.objectByFamily.camera[0].x
      , camera_y = Carre.GameLogic.objectByFamily.camera[0].y
      , directions = {"up": 0, "left": 1, "right": 2}
      , direction = directions[gameObject.type]
    ...
    renderingContext.drawImage(
      ...
      this.spritewidth,
      this.sprite.height,
      gameObject.x - camera_x,
      gameObject.y - camera_y,
      this.spritewidth,
      this.sprite.height);
  }
}
